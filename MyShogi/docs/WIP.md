...
# Update3(2018年11月上旬ごろリリース予定)に向けて作業中です(ここに書かれているすべての機能追加をお約束するものではありません)
...
- "usi","isready"のあとのタイムアウトまでの秒数を設定できるように。
  - keep aliveの処理をすべき
...
- "1.3.3"→"1.3.4" [2018/11/07]-[2018/11/XX]
  - Hashの値が超巨大だとtime outになるのを修正。

...
- 思考エンジン側
  - Aperyの定跡ファイル(book.bin)はBookDirオプションを無視して、"book/book.bin"を読みに行っている。(ohtaroさん)
      思考エンジンからのログを確認したところ、
      .././book/book.bin
...
- "1.2.2"→"1.2.3" [2018/09/27]-[2018/09/XX]
  ...
  - S七段～S10級を追加。序盤は弱いのに終盤だけ強いということのないように、人間らしい弱さを追求しました。

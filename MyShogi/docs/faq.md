...
- バグ、要望等は、[『将棋神やねうら王』Update2までの遊戯施設 / やねうら王ブログ](http://yaneuraou.yaneu.com/2018/09/06/%E3%80%8E%E5%B0%86%E6%A3%8B%E7%A5%9E%E3%82%84%E3%81%AD%E3%81%86%E3%82%89%E7%8E%8B%E3%80%8Fupdate2%E3%81%BE%E3%81%A7%E3%81%AE%E9%81%8A%E6%88%AF%E6%96%BD%E8%A8%AD/)
  にどうぞ。
...
- 連続対局で9段同士を戦わせてみたところ次のような結果になりました。(uuunuuunさん)
...
- Update2で「十段」「十一段」「十二段」が追加されます。
  NodeLimits(探索局面数)で制限をかけて棋力を調整しているので、nps(1秒間の探索局面数)が高いソフトほど不利になる傾向はあります。
  計測したところ「十二段」では、tanuki-2018 が強く、やねうら王が 最も弱くなっています。(masaさん)
    - 定跡16手（256手で引き分け）
    tanuki-2018(十二段)
...
- Update2では「九段」の上の段位、「十段」「十一段」「十二段」のプリセットを用意する予定です。「十二段」は将棋倶楽部24換算でR3800に相当。(人類未到達。人類の最高はR3312)
...
- Update1で「対局開始」「対局終了」の表示が追加されました。それでいかがでしょうか。
...
-　V1.00(製品版のDVD-ROM)では、「デバッグの開始」「ロギングの開始」となっていましたが、Update1で「デバッグの開始」というメニュー項目は無くなりました。

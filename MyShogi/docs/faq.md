...
- 32bit版は動作保証外です。(動作すること自体は確認していますが)
- 64bit版に向けて最適化されているので、棋力はかなり変わります。eloレーティングで言うとR50～R100ぐらい変わりかねないです。
...
-　V1.00では、「デバッグの開始」「ロギングの開始」となっていましたが、Update1(9月中旬を予定)で「デバッグの開始」というメニュー項目は無くなります。

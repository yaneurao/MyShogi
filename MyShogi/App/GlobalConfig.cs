...
namespace MyShogi.App
{
    ...
    public class GlobalConfig : NotifyObject
    {
        ...
        /// 『将棋神やねうら王』のUpdate1   [2018/08/31]は、"1.1.0"。→　アンチウイルスソフトによってファイルコピーが失敗する環境があったのでUpdate1.2を公式で配布することに。
        /// 『将棋神やねうら王』のUpdate1.2 [2018/09/03]は、"1.1.2"。
        /// 『将棋神やねうら王』のUpdate2   [2018/09/XX]は、"1.2.0"を予定。
        /// </summary>
        public static readonly string MYSHOGI_VERSION_STRING = "1.1.2";
